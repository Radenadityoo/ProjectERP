...
@section('content')
<div class="space-y-6">
    <form action="{{ route('invoicing.invoices.update', $invoice['id']) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" value="{{ $invoice['number'] }}" disabled class="w-full px-4 py-2 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-500 dark:text-gray-400">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="invoice_date" value="{{ $invoice['invoice_date'] }}" required class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5A8E74]">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Due Date *</label>
                            <input type="date" name="due_date" value="{{ $invoice['due_date'] }}" required class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5A8E74]">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="reference" value="{{ $invoice['reference'] }}" class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5A8E74]">
                        </div>
                    </div>
                </div>
                        ...
                        <table class="w-full" id="invoiceLinesTable">
                            ...
                            <tbody id="invoiceLinesBody" class="divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                <tr class="invoice-line">
                                    ...
                                    <td class="px-3 py-2">
                                        <input type="text" name="lines[{{ $index }}][label]" value="{{ $line['label'] }}" class="w-full px-2 py-1 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded text-sm text-gray-900 dark:text-gray-100">
                                    </td>
                                    <td class="px-3 py-2">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 sticky top-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <button type="submit" name="action" value="validate" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
                            Validate Invoice
                        </button>
                        @endif
...
<script>
    let lineCounter = {{ count($invoice['lines']) }};
    ...
    function addInvoiceLine() {
        ...
        tr.innerHTML = `
            ...
            <td class="px-3 py-2">
                <input type="text" name="lines[${lineCounter}][label]" class="w-full px-2 py-1 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded text-sm text-gray-900 dark:text-gray-100">
            </td>
            <td class="px-3 py-2">
    ...
    document.querySelectorAll('.invoice-line').forEach(tr => attachLineEvents(tr));
