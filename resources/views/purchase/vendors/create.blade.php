...
<div class="p-6 max-w-4xl space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 space-y-4">
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" class="w-full mt-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" placeholder="Vendor name">
            </div>
            <div>
                <label class="text-sm text-gray-600 dark:text-gray-400">Email</label>
                <input type="email" class="w-full mt-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" placeholder="vendor@email.com">
            </div>
            <div>
                <label class="text-sm text-gray-600 dark:text-gray-400">Phone</label>
                <input type="text" class="w-full mt-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" placeholder="+1 555 1234">
            </div>
            <div>
        ...
        <div>
            ...
            <textarea rows="2" class="w-full mt-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" placeholder="Street, City, State, ZIP"></textarea>
        </div>
        ...
        <div>
            ...
            <textarea rows="3" class="w-full mt-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" placeholder="Internal notes"></textarea>
        </div>
    </div>
    ...
    <div class="flex gap-3">
        ...
        <button type="button" onclick="alert('Demo: Vendor saved successfully!')" class="px-4 py-2 rounded-lg bg-erp text-white hover:bg-opacity-90 text-sm font-semibold">Save</button>
    </div>
</div>
@endsection
