    ...
    <div class="p-6 space-y-6">
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full mt-1 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                            <option value="Draft" @if($po->status == 'Draft') selected @endif>Draft</option>
                            <option value="Waiting" @if($po->status == 'Waiting') selected @endif>Waiting</option>
                            <option value="Purchase" @if($po->status == 'Purchase') selected @endif>Purchase</option>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="p-4 flex items-center justify-between">
                ...
                <button class="inline-flex items-center px-3 py-2 rounded-xl bg-erp text-white hover:bg-opacity-90 text-sm font-medium" type="button" onclick="addOrderLine()">Add Product Line</button>
            </div>
