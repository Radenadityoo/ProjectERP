    ...
    <div class="p-6 space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 grid md:grid-cols-2 gap-4">
            <div class="space-y-3">
                <div>
                    ...
                    <select name="vendor_id" required class="w-full mt-1 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="order_date" required class="w-full mt-1 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" value="2025-12-08">
                    </div>
                    <div>
                        <label class="text-sm text-gray-600 dark:text-gray-400">Reference</label>
                        <input type="text" name="reference" placeholder="Internal reference" class="w-full mt-1 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" value="REF-PO-NEW">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 inline-flex px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200">
                            Draft
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="p-4 flex items-center justify-between">
                ...
                <button type="button" class="inline-flex items-center px-3 py-2 rounded-xl bg-erp text-white hover:bg-opacity-90 text-sm font-medium" onclick="addOrderLine()">Add Product Line</button>
            </div>
                ...
                <table class="min-w-full text-sm" id="orderLines">
                    ...
                    <tbody id="orderLineBody" class="divide-y divide-gray-100 dark:divide-gray-700">
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-900 order-line">
                            ...
                            <td class="px-4 py-3">
                                <input type="text" name="description[]" placeholder="Description" class="w-full px-2 py-1.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-sm" />
                            </td>
                            <td class="px-4 py-3">
                                <input type="number" name="quantity[]" value="1" class="w-20 px-2 py-1.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-sm qty-input" onchange="calculateSubtotal(this)" />
                            </td>
                            <td class="px-4 py-3">
                                <input type="number" name="unit_price[]" value="0" class="w-24 px-2 py-1.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-sm price-input" onchange="calculateSubtotal(this)" />
                            </td>
                            <td class="px-4 py-3">
                                <select name="tax_rate[]" class="w-full px-2 py-1.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-sm">
                                    <option>0%</option>
                                    <option>10%</option>
                                </select>
                            </td>
                            ...
                            <td class="px-4 py-3 text-right">
                                <button type="button" class="text-red-600 dark:text-red-400 hover:underline text-sm" onclick="removeOrderLine(this)">Remove</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
