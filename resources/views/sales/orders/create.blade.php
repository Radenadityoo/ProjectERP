                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="order_date" value="{{ date('Y-m-d') }}" required class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5A8E74]">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="pricelist" class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5A8E74]">
                                                <option value="standard" selected>Standard Price</option>
    ...
    <script>
        ...
        function addOrderLine() {
            ...
            tr.innerHTML = `
                ...
                <td class="px-3 py-2">
                    <input type="text" name="lines[${lineCounter}][description]" class="w-full px-2 py-1 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded text-sm text-gray-900 dark:text-gray-100" placeholder="Description">
                </td>
                <td class="px-3 py-2">
